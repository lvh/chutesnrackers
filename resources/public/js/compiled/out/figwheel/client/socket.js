...
var log__delegate = function (p__26753,args){
var map__26755 = p__26753;
...
var debug = cljs.core.get.call(null,map__26755__$1,new cljs.core.Keyword(null,"debug","debug",-1608172596));
...
var log = function (p__26753,var_args){
var args = null;
if (arguments.length > 1) {
var G__26756__i = 0, G__26756__a = new Array(arguments.length -  1);
while (G__26756__i < G__26756__a.length) {G__26756__a[G__26756__i] = arguments[G__26756__i + 1]; ++G__26756__i;}
  args = new cljs.core.IndexedSeq(G__26756__a,0);
} 
return log__delegate.call(this,p__26753,args);};
log.cljs$lang$maxFixedArity = 1;
log.cljs$lang$applyTo = (function (arglist__26757){
var p__26753 = cljs.core.first(arglist__26757);
var args = cljs.core.rest(arglist__26757);
return log__delegate(p__26753,args);
});
...
figwheel.client.socket.open = (function open(p__26758){
...
var build_id = cljs.core.get.call(null,map__26760__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var websocket_url = cljs.core.get.call(null,map__26760__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var retried_count = cljs.core.get.call(null,map__26760__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__26760__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (socket,map__26760,map__26760__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (msg_str){
var temp__4126__auto__ = cljs.reader.read_string.call(null,msg_str.data);
if(cljs.core.truth_(temp__4126__auto__)){
var msg = temp__4126__auto__;
var and__12631__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__12631__auto__){
var and__12631__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__12631__auto____$1)){
var and__12631__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
if(and__12631__auto____$2){
var and__12631__auto____$3 = figwheel.client.socket.proper_build_id.call(null,build_id,msg);
if(and__12631__auto____$3){
...
});})(socket,map__26760,map__26760__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (socket,map__26760,map__26760__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (socket,map__26760,map__26760__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
var retried_count__$1 = (function (){var or__12643__auto__ = retried_count;
...
return window.setTimeout(((function (retried_count__$1,socket,map__26760,map__26760__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,socket,map__26760,map__26760__$1,opts,build_id,websocket_url,retried_count,retry_count))
,(function (){var x__12967__auto__ = (10000);
var y__12968__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (socket,map__26760,map__26760__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1422998149685